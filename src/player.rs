use crate::components::{
    Action, Animation, AnimationIndexRange, AnimationTimer, Collider, Collision, Direction,
    EntitySize, Player, Speed, Sprint,
};
use bevy::prelude::*;
...
fn spawn_player(
    ...
    let atlas = TextureAtlas::from_grid(image, Vec2::new(SIZE_X, SIZE_Y), 4, 11);
